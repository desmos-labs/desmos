...
func GetWasmOpts(
	...
	customQueryPlugin := NewDesmosCustomQueryPlugin(cdc, profilesKeeper, subspacesKeeper, relationshipsKeeper, reportsKeeper)
...
func NewDesmosApp(
	...
	wasmOpts := GetWasmOpts(appOpts, app.appCodec, app.ProfileKeeper, app.SubspacesKeeper, app.RelationshipsKeeper, app.ReportsKeeper)
