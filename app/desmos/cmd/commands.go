...
func appExport(
	...
	if height != -1 {
		desmosApp = app.NewDesmosApp(logger, db, traceStore, false, appOpts)

		if err := desmosApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		desmosApp = app.NewDesmosApp(logger, db, traceStore, true, appOpts)
	}

	return desmosApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs, modulesToExport)
}

var tempDir = func() string {
	dir, err := os.MkdirTemp("", "desmos")
	if err != nil {
