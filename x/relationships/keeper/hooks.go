...
func (h Hooks) AfterUserPermissionSet(sdk.Context, uint64, uint32, sdk.AccAddress, subspacestypes.Permission) {
}
func (h Hooks) AfterUserPermissionRemoved(sdk.Context, uint64, uint32, sdk.AccAddress) {}
