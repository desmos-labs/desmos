...
func (m *MockSubspacesKeeper) GetAllSections(ctx types.Context) []types0.Section {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllSections", ctx)
	ret0, _ := ret[0].([]types0.Section)
	return ret0
}

// GetAllSections indicates an expected call of GetAllSections.
func (mr *MockSubspacesKeeperMockRecorder) GetAllSections(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllSections", reflect.TypeOf((*MockSubspacesKeeper)(nil).GetAllSections), ctx)
}

// GetUsersWithRootPermissions mocks base method.
func (m *MockSubspacesKeeper) GetUsersWithRootPermissions(ctx types.Context, subspaceID uint64, permission types0.Permissions) []string {
	m.ctrl.T.Helper()
