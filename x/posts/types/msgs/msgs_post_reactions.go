...
type MsgAddPostReaction struct {
	PostID   models.PostID  `json:"post_id" yaml:"post_id"`   // RelationshipID of the post to react to
...
type MsgRemovePostReaction struct {
	PostID   models.PostID  `json:"post_id" yaml:"post_id"`   // RelationshipID of the post to unlike
