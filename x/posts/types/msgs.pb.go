...
type MsgCreatePost struct {
	...
	Attachments []types.Any `protobuf:"bytes,5,rep,name=attachments,proto3" json:"attachments"`
	// Author of the post
	...
	ReplySettings ReplySetting `protobuf:"varint,8,opt,name=reply_settings,json=replySettings,proto3,enum=desmos.posts.v1.ReplySetting" json:"reply_settings,omitempty"`
...
type MsgAddPostAttachment struct {
	...
	Content types.Any `protobuf:"bytes,3,opt,name=content,proto3" json:"content"`
	// Editor of the post
...
func (m *MsgRemovePostAttachment) GetSigner() string {
	if m != nil {
		return m.Signer
	}
	return ""
...
var fileDescriptor_d9b1165b51f80014 = []byte{
	...
	,
}
