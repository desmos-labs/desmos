...
// QueryPollTallyResultsRequest is the request type for the
// Query/PollTallyResults RPC method
type QueryPollTallyResultsRequest struct {
	// Id of the subspace inside which the post containing the poll lies
	SubspaceId uint64 `protobuf:"varint,1,opt,name=subspace_id,json=subspaceId,proto3" json:"subspace_id,omitempty"`
	// Id of the post that contains the poll to query the results for
	PostId uint64 `protobuf:"varint,2,opt,name=post_id,json=postId,proto3" json:"post_id,omitempty"`
	// Id of the poll to query the results for
	PollId uint32 `protobuf:"varint,3,opt,name=poll_id,json=pollId,proto3" json:"poll_id,omitempty"`
}

func (m *QueryPollTallyResultsRequest) Reset()         { *m = QueryPollTallyResultsRequest{} }
func (m *QueryPollTallyResultsRequest) String() string { return proto.CompactTextString(m) }
func (*QueryPollTallyResultsRequest) ProtoMessage()    {}
func (*QueryPollTallyResultsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_8109ee6901cf86f4, []int{8}
}
func (m *QueryPollTallyResultsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryPollTallyResultsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryPollTallyResultsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryPollTallyResultsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryPollTallyResultsRequest.Merge(m, src)
}
func (m *QueryPollTallyResultsRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryPollTallyResultsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryPollTallyResultsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryPollTallyResultsRequest proto.InternalMessageInfo

func (m *QueryPollTallyResultsRequest) GetSubspaceId() uint64 {
	if m != nil {
		return m.SubspaceId
	}
	return 0
...
func (m *QueryPollTallyResultsRequest) GetPostId() uint64 {
	if m != nil {
		return m.PostId
	}
	return 0
...
func (m *QueryPollTallyResultsRequest) GetPollId() uint32 {
	if m != nil {
		return m.PollId
	}
	return 0
...
// QueryPollTallyResultsResponse is the response type for the
// Query/PollTallyResults RPC method
type QueryPollTallyResultsResponse struct {
	Results PollTallyResults `protobuf:"bytes,1,opt,name=results,proto3" json:"results"`
}

func (m *QueryPollTallyResultsResponse) Reset()         { *m = QueryPollTallyResultsResponse{} }
func (m *QueryPollTallyResultsResponse) String() string { return proto.CompactTextString(m) }
func (*QueryPollTallyResultsResponse) ProtoMessage()    {}
func (*QueryPollTallyResultsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_8109ee6901cf86f4, []int{9}
}
func (m *QueryPollTallyResultsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryPollTallyResultsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryPollTallyResultsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryPollTallyResultsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryPollTallyResultsResponse.Merge(m, src)
}
func (m *QueryPollTallyResultsResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryPollTallyResultsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryPollTallyResultsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryPollTallyResultsResponse proto.InternalMessageInfo

func (m *QueryPollTallyResultsResponse) GetResults() PollTallyResults {
	if m != nil {
		return m.Results
	}
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_8109ee6901cf86f4, []int{10}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_8109ee6901cf86f4, []int{11}
}
...
func init() {
	...
	proto.RegisterType((*QueryPollTallyResultsRequest)(nil), "desmos.posts.v1.QueryPollTallyResultsRequest")
	proto.RegisterType((*QueryPollTallyResultsResponse)(nil), "desmos.posts.v1.QueryPollTallyResultsResponse")
...
var fileDescriptor_8109ee6901cf86f4 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	PollTallyResults(ctx context.Context, in *QueryPollTallyResultsRequest, opts ...grpc.CallOption) (*QueryPollTallyResultsResponse, error)
...
func (c *queryClient) PollTallyResults(ctx context.Context, in *QueryPollTallyResultsRequest, opts ...grpc.CallOption) (*QueryPollTallyResultsResponse, error) {
	out := new(QueryPollTallyResultsResponse)
	err := c.cc.Invoke(ctx, "/desmos.posts.v1.Query/PollTallyResults", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// PollTallyResults queries the tally results for an ended poll
	PollTallyResults(context.Context, *QueryPollTallyResultsRequest) (*QueryPollTallyResultsResponse, error)
	// Params queries the module parameters
...
func (*UnimplementedQueryServer) PollTallyResults(ctx context.Context, req *QueryPollTallyResultsRequest) (*QueryPollTallyResultsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PollTallyResults not implemented")
}
...
func _Query_PollTallyResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryPollTallyResultsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).PollTallyResults(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/desmos.posts.v1.Query/PollTallyResults",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).PollTallyResults(ctx, req.(*QueryPollTallyResultsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PollTallyResults",
			Handler:    _Query_PollTallyResults_Handler,
		},
		{
			MethodName: "Params",
...
func (m *QueryPollTallyResultsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryPollTallyResultsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryPollTallyResultsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryPollTallyResultsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryPollTallyResultsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryPollTallyResultsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryPollTallyResultsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryPollTallyResultsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryPollTallyResultsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryPollTallyResultsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryPollTallyResultsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QueryPollTallyResultsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryPollTallyResultsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryPollTallyResultsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
