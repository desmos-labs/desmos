...
func TestIsValidPostID(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.postID, func(t *testing.T) {
			require.Equal(t, test.expValid, types2.IsValidPostID(test.postID))
		})
	}
}
...
func TestIsValidSubspace(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.subspace, func(t *testing.T) {
			require.Equal(t, test.expValid, types.IsValidSubspace(test.subspace))
		})
	}
}
...
func TestIsValidReactionCode(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.code, func(t *testing.T) {
			require.Equal(t, test.expValid, types2.IsValidReactionCode(test.code))
		})
	}
}
