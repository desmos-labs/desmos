...
import (
	...
	posts "github.com/desmos-labs/desmos/x/posts/client/cli"
)
...
func MsgCreatePost(clientCtx client.Context, from, subspace string, extraArgs ...string) (testutil.BufferWriter, error) {
	...
	return clitestutil.ExecTestCLICmd(clientCtx, posts.GetCmdCreatePost(), args)
}
...
func QueryPostsExec(clientCtx client.Context, extraArgs ...string) (testutil.BufferWriter, error) {
	...
	return clitestutil.ExecTestCLICmd(clientCtx, posts.GetCmdQueryPosts(), args)
}
