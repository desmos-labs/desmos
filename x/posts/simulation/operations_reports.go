...
func SimulateMsgReportPost(
	pk keeper.Keeper, ak authkeeper.AccountKeeper, bk bankkeeper.Keeper,
) simtypes.Operation {
	return func(
...
func randomReportPostFields(
	r *rand.Rand, ctx sdk.Context, accs []simtypes.Account, ak authkeeper.AccountKeeper, pk keeper.Keeper,
) (*ReportsData, bool) {
