...
func TestPostQueryResponse_MarshalJSON(t *testing.T) {
	...
	assert.Equal(t,
		`{"id":"10","parent_id":"0","message":"Post","created":"10","last_edited":"0","allows_comments":true,"owner":"cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47","likes":[{"created":"11","owner":"cosmos1s3nh6tafl4amaxkke9kdejhp09lk93g9ev39r4"},{"created":"12","owner":"cosmos15lt0mflt6j9a9auj7yl3p20xec4xvljge0zhae"}],"children":[{"id":"98","parent_id":"10","message":"First comment!","created":"10","last_edited":"0","allows_comments":true,"owner":"cosmos1s3nh6tafl4amaxkke9kdejhp09lk93g9ev39r4"},{"id":"100","parent_id":"11","message":"Second :(","created":"10","last_edited":"0","allows_comments":true,"owner":"cosmos15lt0mflt6j9a9auj7yl3p20xec4xvljge0zhae"}]}`,
		string(jsonData),
	)
}
