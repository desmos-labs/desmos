		...
		},
		{
			...
			post: types2.Post{
				...
				AdditionalAttributes: []types2.Attribute{
					types2.NewAttribute("key1", "value"),
					types2.NewAttribute("key2", "value"),
					types2.NewAttribute("key3", "value"),
					types2.NewAttribute("key4", "value"),
					types2.NewAttribute("key5", "value"),
					types2.NewAttribute("key6", "value"),
					types2.NewAttribute("key7", "value"),
					types2.NewAttribute("key8", "value"),
					types2.NewAttribute("key9", "value"),
					types2.NewAttribute("key10", "value"),
					types2.NewAttribute("key11", "value"),
				},
				Creator: "cosmos1cjf97gpzwmaf30pzvaargfgr884mpp5ak8f7ns",
			},
			expError: sdkerrors.Wrap(sdkerrors.ErrInvalidRequest,
