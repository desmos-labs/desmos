...
func (suite *KeeperTestSuite) Test_RegisteredReactions() {
	usecases := []struct {
		...
		req             *types2.QueryRegisteredReactionsRequest
		expLen          int
	}{
		{
		...
		},
		{
			...
			req:    &types2.QueryRegisteredReactionsRequest{Subspace: "subspace1"},
			expLen: 1,
		},
		{
			...
			req:    &types2.QueryRegisteredReactionsRequest{Pagination: &query.PageRequest{Limit: 1}},
			expLen: 1,
		},
	}
...
func (suite *KeeperTestSuite) Test_UserAnswers() {
	usecases := []struct {
		...
		req       *types2.QueryUserAnswersRequest
		shouldErr bool
		expLen    int
	}{
		{
		...
		},
		{
			...
			req:       &types2.QueryUserAnswersRequest{PostId: "19de02e105c68a60e45c289bff19fde745bca9c63c38f2095b59e8e8090ae1af"},
			shouldErr: true,
		},
		{
