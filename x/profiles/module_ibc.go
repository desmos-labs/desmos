...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData ibcprofilestypes.IBCProfilesPacketData
	...
	case *ibcprofilestypes.IBCProfilesPacketData_IbcAccountConnectionPacket:
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				ibcprofilestypes.EventTypeIBCAccountConnectionPacket,
				sdk.NewAttribute(sdk.AttributeKeyModule, types.ModuleName),
				sdk.NewAttribute(ibcprofilestypes.AttributeKeyAckSuccess, fmt.Sprintf("%t", err != nil)),
			),
		)
	case *ibcprofilestypes.IBCProfilesPacketData_IbcAccountLinkPacket:
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				ibcprofilestypes.EventTypeIBCAccountLinkPacket,
				sdk.NewAttribute(sdk.AttributeKeyModule, types.ModuleName),
				sdk.NewAttribute(ibcprofilestypes.AttributeKeyAckSuccess, fmt.Sprintf("%t", err != nil)),
			),
		)
...
func (am AppModule) OnAcknowledgementPacket(
	...
	case *ibcprofilestypes.IBCProfilesPacketData_IbcAccountConnectionPacket:
		...
		eventType = ibcprofilestypes.EventTypeIBCAccountConnectionPacket
	case *ibcprofilestypes.IBCProfilesPacketData_IbcAccountLinkPacket:
		err := am.keeper.OnAcknowledgementIBCAccountLinkPacket(ctx, modulePacket, *packet.IbcAccountLinkPacket, ack)
		if err != nil {
			return nil, err
		}
		eventType = ibcprofilestypes.EventTypeIBCAccountLinkPacket
	default:
		errMsg := fmt.Sprintf("unrecognized %s packet type: %T", types.ModuleName, packet)
	...
	ctx.EventManager().EmitEvent(
		sdk.NewEvent(
			eventType,
			sdk.NewAttribute(sdk.AttributeKeyModule, types.ModuleName),
			sdk.NewAttribute(ibcprofilestypes.AttributeKeyAck, fmt.Sprintf("%v", ack)),
		),
	)
	...
	case *channeltypes.Acknowledgement_Result:
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				eventType,
				sdk.NewAttribute(ibcprofilestypes.AttributeKeyAckSuccess, string(resp.Result)),
			),
		)
	case *channeltypes.Acknowledgement_Error:
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				eventType,
				sdk.NewAttribute(ibcprofilestypes.AttributeKeyAckError, resp.Error),
			),
		)
	}
