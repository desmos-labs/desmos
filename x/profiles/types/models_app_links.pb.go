...
type ApplicationLink struct {
	...
	Data Data `protobuf:"bytes,1,opt,name=data,proto3" json:"data" yaml:"data"`
	// State of the link
	State ApplicationLinkState `protobuf:"varint,2,opt,name=state,proto3,enum=desmos.profiles.v1beta1.ApplicationLinkState" json:"state,omitempty" yaml:"state"`
	// OracleRequest represents the request that has been made to the oracle
	OracleRequest OracleRequest `protobuf:"bytes,3,opt,name=oracle_request,json=oracleRequest,proto3" json:"oracle_request" yaml:"oracle_request"`
	// Data coming from the result of the verification.
	// Only available when the state is STATE_SUCCESS
	Result *Result `protobuf:"bytes,4,opt,name=result,proto3" json:"result,omitempty" yaml:"result"`
...
func (m *ApplicationLink) GetData() Data {
	if m != nil {
		return m.Data
	}
	return Data{}
...
func (m *ApplicationLink) GetState() ApplicationLinkState {
	...
	return ApplicationLinkStateInitialized
}
...
func (m *ApplicationLink) GetResult() *Result {
	if m != nil {
		return m.Result
	}
	return nil
...
func (m *Data) GetApplication() string {
	if m != nil {
...
func (m *OracleRequest) GetCallData() OracleRequest_CallData {
	if m != nil {
		return m.CallData
	}
...
// ClientRequest contains the data of a client oracle request
...
func (*ClientRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_33caa1214beac081, []int{4}
}
...
func (m *ClientRequest) GetUser() string {
	if m != nil {
		return m.User
	}
	return ""
...
func (m *ClientRequest) GetApplication() string {
	if m != nil {
		return m.Application
	}
	return ""
...
func (m *ClientRequest) GetUsername() string {
	if m != nil {
		return m.Username
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*ClientRequest)(nil), "desmos.profiles.v1beta1.ClientRequest")
}
...
var fileDescriptor_33caa1214beac081 = []byte{
	...
	,
}
