...
// states: STARTED, ERRORED, SUCCESSFUL, TIMED_OUT, EXPIRED
...
const (
	...
	// A link has been expired
	AppLinkStateVerificationExpired ApplicationLinkState = 5
)
...
var ApplicationLinkState_name = map[int32]string{
	...
	5: "APPLICATION_LINK_STATE_VERIFICATION_EXPIRED",
}
...
var ApplicationLinkState_value = map[string]int32{
	...
	"APPLICATION_LINK_STATE_VERIFICATION_EXPIRED":    5,
}
...
type ApplicationLink struct {
	...
	ExpirationBlockHeight uint64 `protobuf:"varint,7,opt,name=expiration_block_height,json=expirationBlockHeight,proto3" json:"expiration_block_height,omitempty" yaml:"expiration_block_height"`
}
...
var fileDescriptor_33caa1214beac081 = []byte{
	...
	,
}
...
func (this *ApplicationLink) Equal(that interface{}) bool {
	...
	if this.ExpirationBlockHeight != that1.ExpirationBlockHeight {
		return false
	}
	return true
}
...
func (m *ApplicationLink) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ExpirationBlockHeight != 0 {
		i = encodeVarintModelsAppLinks(dAtA, i, uint64(m.ExpirationBlockHeight))
		i--
		dAtA[i] = 0x38
	}
...
func (m *ApplicationLink) Size() (n int) {
	...
	n += 1 + l + sovModelsAppLinks(uint64(l))
	if m.ExpirationBlockHeight != 0 {
		n += 1 + sovModelsAppLinks(uint64(m.ExpirationBlockHeight))
	}
	return n
}
...
func (m *ApplicationLink) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExpirationBlockHeight", wireType)
			}
			m.ExpirationBlockHeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowModelsAppLinks
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ExpirationBlockHeight |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
