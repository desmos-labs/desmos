...
type ApplicationLinkParams struct {
	...
	ExpiryInterval int64 `protobuf:"varint,1,opt,name=expiry_interval,json=expiryInterval,proto3" json:"expiry_interval,omitempty" yaml:"expiry_interval"`
}
...
var fileDescriptor_a621950d5c07fbad = []byte{
	...
	0x95, 0xda, 0x02, 0x6b, 0xb8, 0x1f, 0x92, 0x68, 0x60, 0x91, 0x20, 0xc1, 0xd1, 0x35, 0xf2, 0xa4,
	0xdf, 0xbb, 0xa3, 0x54, 0xdb, 0x1e, 0xf7, 0x63, 0x26, 0x00, 0x9a, 0xab, 0x62, 0xa7, 0x2d, 0x37,
	0x44, 0x0e, 0xe3, 0xf4, 0x66, 0x58, 0xcb, 0xdf, 0x0e, 0x6b, 0xf9, 0x4f, 0xc3, 0x5a, 0xfe, 0xcd,
	0x7d, 0x2d, 0x77, 0x7b, 0x5f, 0xcb, 0x7d, 0xb8, 0xaf, 0xe5, 0x9e, 0xeb, 0x53, 0x85, 0x8b, 0x51,
	0xba, 0xef, 0x21, 0x3b, 0x96, 0xeb, 0x46, 0x7f, 0xf2, 0x39, 0xe5, 0x97, 0xb0, 0x8b, 0xfc, 0x83,
	0xf7, 0xef, 0xe7, 0x00, 0x00, 0x00, 0xff, 0xff, 0x06, 0xe8, 0x3e, 0x86, 0x6e, 0x07, 0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ExpiryInterval |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
