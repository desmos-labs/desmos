...
// source: desmos/profiles/v4/query_dtag_requests.proto
...
func (*QueryIncomingDTagTransferRequestsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_8145cb210961cc1c, []int{0}
}
...
func (*QueryIncomingDTagTransferRequestsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_8145cb210961cc1c, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryIncomingDTagTransferRequestsRequest)(nil), "desmos.profiles.v4.QueryIncomingDTagTransferRequestsRequest")
	proto.RegisterType((*QueryIncomingDTagTransferRequestsResponse)(nil), "desmos.profiles.v4.QueryIncomingDTagTransferRequestsResponse")
}

func init() {
	proto.RegisterFile("desmos/profiles/v4/query_dtag_requests.proto", fileDescriptor_8145cb210961cc1c)
}

var fileDescriptor_8145cb210961cc1c = []byte{
	...
	0xda, 0x6a, 0xe9, 0xc4, 0x58, 0x21, 0x50, 0xc5, 0x02, 0x51, 0x27, 0x96, 0xca, 0x49, 0xff, 0x9a,
	...
	0x96, 0xea, 0x4f, 0x65, 0x8c, 0x13, 0x91, 0x13, 0x43, 0x39, 0xca, 0x68, 0xac, 0xec, 0xb9, 0x5e,
	0xfd, 0xe7, 0xcb, 0x8f, 0xa0, 0xb7, 0x05, 0xa8, 0xf8, 0x61, 0xb3, 0xb0, 0x97, 0x7f, 0x02, 0x00,
	0x00, 0xff, 0xff, 0xb0, 0x7e, 0xe1, 0xce, 0xb9, 0x02, 0x00, 0x00,
}
