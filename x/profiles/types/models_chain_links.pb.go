...
// EthHexAddress represents an Eth Hex-encoded address
type EthHexAddress struct {
	// Value represents the Eth hex address value
	Value string `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty" yaml:"value"`
}

func (m *EthHexAddress) Reset()         { *m = EthHexAddress{} }
func (m *EthHexAddress) String() string { return proto.CompactTextString(m) }
func (*EthHexAddress) ProtoMessage()    {}
func (*EthHexAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_1c1946212735e419, []int{5}
}
func (m *EthHexAddress) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EthHexAddress) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EthHexAddress.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EthHexAddress) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EthHexAddress.Merge(m, src)
}
func (m *EthHexAddress) XXX_Size() int {
	return m.Size()
}
func (m *EthHexAddress) XXX_DiscardUnknown() {
	xxx_messageInfo_EthHexAddress.DiscardUnknown(m)
}

var xxx_messageInfo_EthHexAddress proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*EthHexAddress)(nil), "desmos.profiles.v1beta1.EthHexAddress")
}
...
var fileDescriptor_1c1946212735e419 = []byte{
	...
	,
}
...
func (this *EthHexAddress) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*EthHexAddress)
	if !ok {
		that2, ok := that.(EthHexAddress)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *EthHexAddress) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EthHexAddress) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EthHexAddress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EthHexAddress) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EthHexAddress) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EthHexAddress: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EthHexAddress: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
