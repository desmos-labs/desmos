...
// CosmosSignMode represents the various signing mode that a
// CosmosSingleSignature can use
type CosmosSignMode int32

const (
	// COSMOS_SIGN_MODE_UNSPECIFIED specifies an unknown signing mode and will be
	// rejected
	COSMOS_SIGN_MODE_UNSPECIFIED CosmosSignMode = 0
	// COSMOS_SIGN_MODE_DIRECT specifies a signing mode that requires the value to
	// be a transaction encoded using Protobuf and containing the owner address
	// inside its memo field
	COSMOS_SIGN_MODE_DIRECT CosmosSignMode = 1
	// COSMOS_SIGN_MODE_AMINO specifies a signing mode that requires the value to
	// be a transaction encoded using Amino and containing the owner address
	// inside its memo field
	COSMOS_SIGN_MODE_AMINO CosmosSignMode = 2
	// COSMOS_SIGN_MODE_RAW specifies a signing mode that requires the value to be
	// signed directly without any kind of structure
	COSMOS_SIGN_MODE_RAW CosmosSignMode = 3
)

var CosmosSignMode_name = map[int32]string{
	0: "COSMOS_SIGN_MODE_UNSPECIFIED",
	1: "COSMOS_SIGN_MODE_DIRECT",
	2: "COSMOS_SIGN_MODE_AMINO",
	3: "COSMOS_SIGN_MODE_RAW",
}

var CosmosSignMode_value = map[string]int32{
	"COSMOS_SIGN_MODE_UNSPECIFIED": 0,
	"COSMOS_SIGN_MODE_DIRECT":      1,
	"COSMOS_SIGN_MODE_AMINO":       2,
	"COSMOS_SIGN_MODE_RAW":         3,
}

func (x CosmosSignMode) String() string {
	return proto.EnumName(CosmosSignMode_name, int32(x))
}

func (CosmosSignMode) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	EVM_SIGNATURE_METHOD_UNSPECIFIED EVMSignatureMethod = 0
...
type CosmosSingleSignature struct {
	// Mode is the signing mode of the single signer
	SignMode CosmosSignMode `protobuf:"varint,1,opt,name=sign_mode,json=signMode,proto3,enum=desmos.profiles.v3.CosmosSignMode" json:"sign_mode,omitempty" yaml:"sign_mode"`
	// Signature is the raw signature bytes
	Signature []byte `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty" yaml:"signature"`
}

func (m *CosmosSingleSignature) Reset()         { *m = CosmosSingleSignature{} }
func (m *CosmosSingleSignature) String() string { return proto.CompactTextString(m) }
func (*CosmosSingleSignature) ProtoMessage()    {}
func (*CosmosSingleSignature) Descriptor() ([]byte, []int) {
	return fileDescriptor_29bee920e792da29, []int{6}
}
func (m *CosmosSingleSignature) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CosmosSingleSignature) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CosmosSingleSignature.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CosmosSingleSignature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CosmosSingleSignature.Merge(m, src)
}
func (m *CosmosSingleSignature) XXX_Size() int {
	return m.Size()
}
func (m *CosmosSingleSignature) XXX_DiscardUnknown() {
	xxx_messageInfo_CosmosSingleSignature.DiscardUnknown(m)
}

var xxx_messageInfo_CosmosSingleSignature proto.InternalMessageInfo
...
func init() {
	proto.RegisterEnum("desmos.profiles.v3.CosmosSignMode", CosmosSignMode_name, CosmosSignMode_value)
	...
	proto.RegisterType((*CosmosSingleSignature)(nil), "desmos.profiles.v3.CosmosSingleSignature")
...
var fileDescriptor_29bee920e792da29 = []byte{
	...
	,
}
...
func (this *CosmosSingleSignature) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CosmosSingleSignature)
	if !ok {
		that2, ok := that.(CosmosSingleSignature)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.SignMode != that1.SignMode {
		return false
	}
...
func (m *CosmosSingleSignature) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CosmosSingleSignature) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CosmosSingleSignature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.SignMode != 0 {
		i = encodeVarintModelsChainLinks(dAtA, i, uint64(m.SignMode))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *CosmosSingleSignature) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SignMode != 0 {
		n += 1 + sovModelsChainLinks(uint64(m.SignMode))
	}
	l = len(m.Signature)
	if l > 0 {
		n += 1 + l + sovModelsChainLinks(uint64(l))
...
func (m *CosmosSingleSignature) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CosmosSingleSignature: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CosmosSingleSignature: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SignMode |= CosmosSignMode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
