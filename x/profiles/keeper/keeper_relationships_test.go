...
func (suite *KeeperTestSuite) TestKeeper_DeleteSubspaceUserRelationships() {
	...
	suite.k.DeleteSubspaceUserRelationships(ctx, "cosmos1y54exmx84cqtasvjnskf9f63djuuj68p7hqf47", "subspace-1")
	...
	suite.Require().Equal(expRelationships, suite.k.GetAllRelationships(ctx))
}
