				...
				store.Set(
					...
					types.MustMarshalChainLink(
						...
						types.NewChainLink(
							...
							types.NewProof(pub1, profilestesting.SingleCosmosSignatureFromHex("1234"), "plain_text"),
				...
				store.Set(
					...
					types.MustMarshalChainLink(
						...
						types.NewChainLink(
							...
							types.NewProof(pub2, profilestesting.SingleCosmosSignatureFromHex("1234"), "plain_text"),
							types.NewChainConfig("cosmos"),
							time.Date(2020, 1, 2, 00, 00, 00, 000, time.UTC),
						),
					),
