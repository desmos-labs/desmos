...
// DeleteAllUserDTagTransferRequests deletes all the requests made to the given user
func (k Keeper) DeleteAllUserDTagTransferRequests(ctx sdk.Context, receiver string) {
