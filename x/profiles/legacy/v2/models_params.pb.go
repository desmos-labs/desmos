...
// source: desmos/profiles/legacy/v2/models_params.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "desmos.profiles.legacy.v2.Params")
	proto.RegisterType((*NicknameParams)(nil), "desmos.profiles.legacy.v2.NicknameParams")
	proto.RegisterType((*DTagParams)(nil), "desmos.profiles.legacy.v2.DTagParams")
	proto.RegisterType((*BioParams)(nil), "desmos.profiles.legacy.v2.BioParams")
	proto.RegisterType((*OracleParams)(nil), "desmos.profiles.legacy.v2.OracleParams")
}

func init() {
	proto.RegisterFile("desmos/profiles/legacy/v2/models_params.proto", fileDescriptor_25d12bc4496b54d5)
}
