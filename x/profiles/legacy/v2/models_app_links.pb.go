...
// source: desmos/profiles/legacy/v2/models_app_links.proto
...
type ApplicationLink struct {
	...
	// State of the link
	State ApplicationLinkState `protobuf:"varint,3,opt,name=state,proto3,enum=desmos.profiles.legacy.v2.ApplicationLinkState" json:"state,omitempty" yaml:"state"`
...
func init() {
	proto.RegisterEnum("desmos.profiles.legacy.v2.ApplicationLinkState", ApplicationLinkState_name, ApplicationLinkState_value)
	proto.RegisterType((*ApplicationLink)(nil), "desmos.profiles.legacy.v2.ApplicationLink")
	proto.RegisterType((*Data)(nil), "desmos.profiles.legacy.v2.Data")
	proto.RegisterType((*OracleRequest)(nil), "desmos.profiles.legacy.v2.OracleRequest")
	proto.RegisterType((*OracleRequest_CallData)(nil), "desmos.profiles.legacy.v2.OracleRequest.CallData")
	proto.RegisterType((*Result)(nil), "desmos.profiles.legacy.v2.Result")
	proto.RegisterType((*Result_Success)(nil), "desmos.profiles.legacy.v2.Result.Success")
	proto.RegisterType((*Result_Failed)(nil), "desmos.profiles.legacy.v2.Result.Failed")
}

func init() {
	proto.RegisterFile("desmos/profiles/legacy/v2/models_app_links.proto", fileDescriptor_5df3c995b2a7b875)
}
