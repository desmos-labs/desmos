...
func TestMigrateStore(t *testing.T) {
	...
	pk := postskeeper.NewKeeper(cdc, keys[poststypes.StoreKey], paramsKeeper.Subspace(poststypes.DefaultParamsSpace), ak, sk, rk, authtypes.NewModuleAddress("gov").String())
