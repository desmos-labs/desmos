...
func GetCmdReportPost(cdc *codec.Codec) *cobra.Command {
	return &cobra.Command{
		Use:   "report [post-id] [report-type] [report-message]",
		Short: "report a post",
		Long: fmt.Sprintf(`
Report an existent post specifying its ID, the report's type and message.

E.g.
%s tx report a4469741bb0c0622627810082a5f2e4e54fbbb888f25a4771a5eebc697d30cfc scam "this post is a scam" 
`, version.ClientName),
