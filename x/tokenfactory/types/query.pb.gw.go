...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"desmos", "tokenfactory", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SubspaceDenoms_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"desmos", "tokenfactory", "v1", "subspaces", "subspace_id", "denoms"}, "", runtime.AssumeColonVerbOpt(false)))
)
