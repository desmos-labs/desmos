...
// QueryUserGrantsRequest is the request type for the Query/UserGrants RPC
// method
type QueryUserGrantsRequest struct {
...
func (m *QueryUserGrantsRequest) Reset()         { *m = QueryUserGrantsRequest{} }
func (m *QueryUserGrantsRequest) String() string { return proto.CompactTextString(m) }
func (*QueryUserGrantsRequest) ProtoMessage()    {}
func (*QueryUserGrantsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca70010567dbc47d, []int{17}
}
func (m *QueryUserGrantsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryUserGrantsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryUserGrantsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryUserGrantsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryUserGrantsRequest.Merge(m, src)
}
func (m *QueryUserGrantsRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryUserGrantsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryUserGrantsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryUserGrantsRequest proto.InternalMessageInfo

// QueryUserGrantsResponse is the response type for the Query/UserGrants RPC
// method
type QueryUserGrantsResponse struct {
...
func (m *QueryUserGrantsResponse) Reset()         { *m = QueryUserGrantsResponse{} }
func (m *QueryUserGrantsResponse) String() string { return proto.CompactTextString(m) }
func (*QueryUserGrantsResponse) ProtoMessage()    {}
func (*QueryUserGrantsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca70010567dbc47d, []int{18}
}
func (m *QueryUserGrantsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryUserGrantsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryUserGrantsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryUserGrantsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryUserGrantsResponse.Merge(m, src)
}
func (m *QueryUserGrantsResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryUserGrantsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryUserGrantsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryUserGrantsResponse proto.InternalMessageInfo

func (m *QueryUserGrantsResponse) GetGrants() []UserGrant {
	if m != nil {
		return m.Grants
	}
	return nil
...
func (m *QueryUserGrantsResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
// QueryGroupGrantsRequest is the request type for the Query/GroupGrants RPC
// method
type QueryGroupGrantsRequest struct {
	// the id of the subspace where the granter grants the allowance to the
	// grantee
	SubspaceId uint64 `protobuf:"varint,1,opt,name=subspace_id,json=subspaceId,proto3" json:"subspace_id,omitempty" yaml:"subspace_id"`
	// (optional) the address of the user granting an allowance of their funds
...
func (m *QueryGroupGrantsRequest) Reset()         { *m = QueryGroupGrantsRequest{} }
func (m *QueryGroupGrantsRequest) String() string { return proto.CompactTextString(m) }
func (*QueryGroupGrantsRequest) ProtoMessage()    {}
func (*QueryGroupGrantsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca70010567dbc47d, []int{19}
}
func (m *QueryGroupGrantsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGroupGrantsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGroupGrantsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGroupGrantsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGroupGrantsRequest.Merge(m, src)
}
func (m *QueryGroupGrantsRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryGroupGrantsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGroupGrantsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGroupGrantsRequest proto.InternalMessageInfo

// QueryGroupGrantsResponse is the response type for the Query/GroupGrants RPC
// method
type QueryGroupGrantsResponse struct {
	// grants are allowance's granted for grantee by granter
...
func (m *QueryGroupGrantsResponse) Reset()         { *m = QueryGroupGrantsResponse{} }
func (m *QueryGroupGrantsResponse) String() string { return proto.CompactTextString(m) }
func (*QueryGroupGrantsResponse) ProtoMessage()    {}
func (*QueryGroupGrantsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca70010567dbc47d, []int{20}
}
func (m *QueryGroupGrantsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGroupGrantsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGroupGrantsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGroupGrantsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGroupGrantsResponse.Merge(m, src)
}
func (m *QueryGroupGrantsResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryGroupGrantsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGroupGrantsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGroupGrantsResponse proto.InternalMessageInfo

func (m *QueryGroupGrantsResponse) GetGrants() []GroupGrant {
	if m != nil {
		return m.Grants
	}
	return nil
...
func (m *QueryGroupGrantsResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryUserGrantsRequest)(nil), "desmos.subspaces.v3.QueryUserGrantsRequest")
	proto.RegisterType((*QueryUserGrantsResponse)(nil), "desmos.subspaces.v3.QueryUserGrantsResponse")
	proto.RegisterType((*QueryGroupGrantsRequest)(nil), "desmos.subspaces.v3.QueryGroupGrantsRequest")
	proto.RegisterType((*QueryGroupGrantsResponse)(nil), "desmos.subspaces.v3.QueryGroupGrantsResponse")
}
...
var fileDescriptor_ca70010567dbc47d = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// UserGrants returns all the grants for users.
	UserGrants(ctx context.Context, in *QueryUserGrantsRequest, opts ...grpc.CallOption) (*QueryUserGrantsResponse, error)
	// GroupGrants returns all the grants for groups.
	GroupGrants(ctx context.Context, in *QueryGroupGrantsRequest, opts ...grpc.CallOption) (*QueryGroupGrantsResponse, error)
}
...
func (c *queryClient) UserGrants(ctx context.Context, in *QueryUserGrantsRequest, opts ...grpc.CallOption) (*QueryUserGrantsResponse, error) {
	out := new(QueryUserGrantsResponse)
	err := c.cc.Invoke(ctx, "/desmos.subspaces.v3.Query/UserGrants", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GroupGrants(ctx context.Context, in *QueryGroupGrantsRequest, opts ...grpc.CallOption) (*QueryGroupGrantsResponse, error) {
	out := new(QueryGroupGrantsResponse)
	err := c.cc.Invoke(ctx, "/desmos.subspaces.v3.Query/GroupGrants", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// UserGrants returns all the grants for users.
	UserGrants(context.Context, *QueryUserGrantsRequest) (*QueryUserGrantsResponse, error)
	// GroupGrants returns all the grants for groups.
	GroupGrants(context.Context, *QueryGroupGrantsRequest) (*QueryGroupGrantsResponse, error)
}
...
func (*UnimplementedQueryServer) UserGrants(ctx context.Context, req *QueryUserGrantsRequest) (*QueryUserGrantsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UserGrants not implemented")
}
func (*UnimplementedQueryServer) GroupGrants(ctx context.Context, req *QueryGroupGrantsRequest) (*QueryGroupGrantsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GroupGrants not implemented")
}
...
func _Query_UserGrants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryUserGrantsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).UserGrants(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/desmos.subspaces.v3.Query/UserGrants",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).UserGrants(ctx, req.(*QueryUserGrantsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_GroupGrants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryGroupGrantsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).GroupGrants(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/desmos.subspaces.v3.Query/GroupGrants",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).GroupGrants(ctx, req.(*QueryGroupGrantsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UserGrants",
			Handler:    _Query_UserGrants_Handler,
		},
		{
			MethodName: "GroupGrants",
			Handler:    _Query_GroupGrants_Handler,
		},
	},
...
func (m *QueryUserGrantsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryUserGrantsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryUserGrantsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryUserGrantsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryUserGrantsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryUserGrantsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryGroupGrantsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGroupGrantsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGroupGrantsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryGroupGrantsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGroupGrantsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGroupGrantsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryUserGrantsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryUserGrantsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGroupGrantsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGroupGrantsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryUserGrantsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryUserGrantsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryUserGrantsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QueryUserGrantsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryUserGrantsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryUserGrantsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Grants = append(m.Grants, UserGrant{})
...
func (m *QueryGroupGrantsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGroupGrantsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGroupGrantsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QueryGroupGrantsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGroupGrantsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGroupGrantsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Grants = append(m.Grants, GroupGrant{})
			if err := m.Grants[len(m.Grants)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
