...
func NewTxCmd() *cobra.Command {
	...
	subspacesTxCmd.AddCommand(
		...
		GetCmdGrantUserFeeAllowance(),
		GetCmdGrantGroupFeeAllowance(),
		GetCmdRevokeUserFeeAllowance(),
		GetCmdRevokeGroupFeeAllowance(),
	)
...
// GetCmdGroupFeeGrant returns the command used to grant a user fee allowance
func GetCmdGrantUserFeeAllowance() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "grant-user-fee-allowance [subspace-id] [grantee]",
...
func GetCmdGrantGroupFeeAllowance() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "grant-group-fee-allowance [subspace-id] [group-id]",
