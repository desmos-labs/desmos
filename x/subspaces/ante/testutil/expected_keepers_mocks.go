...
// UseGrantedFees mocks base method.
func (m *MockSubspacesKeeper) UseGrantedFees(ctx types.Context, subspaceID uint64, granter, grantee types.AccAddress, fee types.Coins, msgs []types.Msg) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UseGrantedFees", ctx, subspaceID, granter, grantee, fee, msgs)
	ret0, _ := ret[0].(bool)
	return ret0
}

// UseGrantedFees indicates an expected call of UseGrantedFees.
func (mr *MockSubspacesKeeperMockRecorder) UseGrantedFees(ctx, subspaceID, granter, grantee, fee, msgs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UseGrantedFees", reflect.TypeOf((*MockSubspacesKeeper)(nil).UseGrantedFees), ctx, subspaceID, granter, grantee, fee, msgs)
}