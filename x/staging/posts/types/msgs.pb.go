...
type MsgCreatePost struct {
	...
	CommentsState        CommentsState `protobuf:"varint,3,opt,name=comments_state,json=commentsState,proto3,enum=desmos.posts.v1beta1.CommentsState" json:"comments_state,omitempty" yaml:"comments_state"`
	Subspace             string        `protobuf:"bytes,4,opt,name=subspace,proto3" json:"subspace,omitempty" yaml:"subspace"`
	AdditionalAttributes []Attribute   `protobuf:"bytes,5,rep,name=additional_attributes,json=additionalAttributes,proto3" json:"additional_attributes" yaml:"additional_attributes,omitempty"`
...
type MsgEditPost struct {
	...
	Message       string        `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty" yaml:"message"`
	CommentsState CommentsState `protobuf:"varint,3,opt,name=comments_state,json=commentsState,proto3,enum=desmos.posts.v1beta1.CommentsState" json:"comments_state,omitempty" yaml:"comments_state"`
	Attachments   []Attachment  `protobuf:"bytes,4,rep,name=attachments,proto3" json:"attachments" yaml:"attachments,omitempty"`
...
var fileDescriptor_12fe981997856c11 = []byte{
	...
	,
}
