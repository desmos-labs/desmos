...
type MsgReportPost struct {
	PostID        string   `protobuf:"bytes,1,opt,name=post_id,json=postId,proto3" json:"post_id" yaml:"post_id"`
	ReportReasons []string `protobuf:"bytes,2,rep,name=report_reasons,json=reportReasons,proto3" json:"report_reasons,omitempty" yaml:"reasons"`
...
var fileDescriptor_12fe981997856c11 = []byte{
	...
	,
}
...
func (m *MsgReportPost) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ReportReasons) > 0 {
		for iNdEx := len(m.ReportReasons) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ReportReasons[iNdEx])
			copy(dAtA[i:], m.ReportReasons[iNdEx])
			i = encodeVarintMsgs(dAtA, i, uint64(len(m.ReportReasons[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *MsgReportPost) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReportReasons", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReportReasons = append(m.ReportReasons, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Message", wireType)
