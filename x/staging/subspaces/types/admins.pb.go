...
// source: desmos/subspaces/v1beta1/admins.proto
...
// Admins represent the admin slice that control a specific subspace
type Admins struct {
	Admins []string `protobuf:"bytes,1,rep,name=admins,proto3" json:"admins,omitempty" yaml:"admins,omitempty"`
}
...
func (*Admins) Descriptor() ([]byte, []int) {
	return fileDescriptor_b3820c7171f2a363, []int{0}
}
...
func init() {
	proto.RegisterType((*Admins)(nil), "desmos.subspaces.v1beta1.Admins")
}

func init() {
	proto.RegisterFile("desmos/subspaces/v1beta1/admins.proto", fileDescriptor_b3820c7171f2a363)
}

var fileDescriptor_b3820c7171f2a363 = []byte{
	...
	0x4a, 0x2d, 0x49, 0x34, 0xd4, 0x4f, 0x4c, 0xc9, 0xcd, 0xcc, 0x2b, 0xd6, 0x2b, 0x28, 0xca, 0x2f,
	...
	,
}
...
func (m *Admins) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Admins) > 0 {
		for iNdEx := len(m.Admins) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintAdmins(dAtA, i, uint64(len(m.Admins[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
