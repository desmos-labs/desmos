...
replace (
	...
	github.com/CosmWasm/wasmd => github.com/desmos-labs/wasmd v0.23.1-0.20220407145829-011bbf16d479

	// Our custom fork has some fixes that are not yet available inside an official release
	github.com/cosmos/cosmos-sdk => github.com/desmos-labs/cosmos-sdk v0.43.0-alpha1.0.20220407145510-71d2ba21554f
