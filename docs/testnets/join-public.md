...
To join the public testnet you **must** have [`desmoscli` and `desmosd` installed](docs/fullnode/setup/setup.md).  
:::

To become a testnet validators, the mainnet instructions apply: 

1. [Create a full node](docs/fullnode/setup/setup.md).
