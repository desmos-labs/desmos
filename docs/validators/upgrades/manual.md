...
If you have also setup a [background service](docs/fullnode/setup/manual.md#optional-configure-the-service), please stop that too by executing the following command: 
