...
Go into the directory in which you have installed `desmos`. If you have followed the [installation instructions](docs/fullnode/setup/setup.md) and didn't change the path, it should be `/home/$USER/desmos`: 
