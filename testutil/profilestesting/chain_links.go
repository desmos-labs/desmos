...
func (a ChainLinkAccount) Bech32SignatureData(signedValue string) types.CosmosSignature {
	return types.NewCosmosSingleSignature(signing.SignMode_SIGN_MODE_TEXTUAL, a.Sign(signedValue))
}
