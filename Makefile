...
COSMOS_URL 		 = https://raw.githubusercontent.com/cosmos/cosmos-sdk/v0.42.1/proto/cosmos
...
proto-update-deps:
	...
	@mkdir -p $(COSMOS_TYPES)/auth/v1beta1
	@curl -sSL $(COSMOS_URL)/auth/v1beta1/auth.proto > $(COSMOS_TYPES)/auth/v1beta1/auth.proto
